...
if __name__ == '__main__':
    ...
    weights = []
    # 先手
    random_player1 = player.Computer(color=BLACK)
    # 后手
    ...
    for _ in range(1,train_iter+1):
        ...
        while not board.game_ended():
            ...
            # print("whites_num:{},black_num:{}".format( whites, blacks))

        whites, blacks, empty = board.count_stones()
        # print("Iter:{}, whites_num:{},black_num:{}".format(_,whites,blacks))
        if whites > blacks:
            white_win+=1
        elif blacks > whites:
            black_win+=1
        ...
        random_player2.get_current_board(board)
        current_player = random_player1
        if _==10 or _==20 or _==30 or _==50 or _==100:
            print('Train Iter:{}, black win:{}, white win:{},prob:{}'.format(_, black_win, white_win,black_win/(black_win+white_win)))
